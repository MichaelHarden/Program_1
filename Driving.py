...
def hundred_k_standard_deviation():
    ...
    for _ in range(100_000):
        hundred_k_list.append(drive()) # Stores the drive data into a list
...
ten_ten_thousand_runs_list_std = list()
ten_ten_thousand_runs_list_avg = list()
for _ in range(10):
    ten_ten_thousand_runs_list_avg.append(ten_k())
...
print(f"the standard deviation that was travled over 10 iterations of 10,000 trips is: {statistics.stdev(ten_ten_thousand_runs_list_avg)} ")
print("\n")
